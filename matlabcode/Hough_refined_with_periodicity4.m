function peaks_refined = Hough_refined_with_periodicity4(H_rot,linesH,peaks_grid)
% Parameters
threshold_Hough_zoom = 0.5;
width_zoom = 0.3; % length of square zoom is width_zoom*per_finale
...
for k = 1:2
    ...
    while not_end
        ...
        peaks_refined{k} = [peaks_refined{k}; peaks];
